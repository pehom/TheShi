...
import com.pehom.theshi.presentation.screens.components.drawercreatenewtask.DrawerCreateNewTask
...
fun DrawerCustom(
   ...
   val drawerState = remember { viewModel.drawerType }
    when (drawerState.value) {
        ...
        Constants.DRAWER_PENDING_REQUESTS -> DrawerPendingRequests(viewModel = viewModel, scaffoldState = scaffoldState)
    }
}